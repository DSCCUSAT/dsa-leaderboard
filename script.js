...
get(child(dbRef, `users`)).then((snapshot) => {
  if (snapshot.exists()) {
    ...
    var keysSorted = Object.keys(format).sort(function(a,b){return format[a]-format[b]})
...
var todaysquestion = "running-sum-of-1d-array"
