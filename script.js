...
var usernames = ["Mishal0404","user4713QR", "Nevin",
...
todaysquestion = "running-sum-of-1d-array"
    ...
    for (var i in usernames){
        ...
        fetch(newurl).then( function(response) {return response.json()}).then(function(result){
            //for (var j in questions){
                ...
                if (recents.includes(todaysquestion){
                    saveuser(usernames[i], todaysquestion)
                    console.log("saved")
                }
            //}
            //console.log(recents)
